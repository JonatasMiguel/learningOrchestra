...
class ObjectStorage:
    ...
    def get_read_binary_path(filename: str, service_type: str) -> str:
        if service_type == Constants.MODEL_PYCARET_TYPE:
            return f'{os.environ[Constants.MODELS_VOLUME_PATH]}/{filename}'
        elif service_type == Constants.TRANSFORM_PYCARET_TYPE:
...
class Data:
    ...
    def __is_stored_in_volume(self, filename) -> bool:
        volume_types = [
            Constants.TUNE_PYCARET_TYPE,
            Constants.EVALUATE_PYCARET_TYPE,
            Constants.PREDICT_PYCARET_TYPE,
            Constants.DATASET_PYCARET_TYPE,
            Constants.TRANSFORM_PYCARET_TYPE,
            Constants.EXPLORE_PYCARET_TYPE,
