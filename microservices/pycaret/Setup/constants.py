class Constants:
    ...
    TRAIN_PYCARET_TYPE = "train/pycaret"
    TUNE_PYCARET_TYPE = "tune/pycaret"
    EVALUATE_PYCARET_TYPE = "evaluate/pycaret"
    PREDICT_PYCARET_TYPE = "predict/pycaret"
    DATASET_PYCARET_TYPE = "dataset/pycaret"
    TRANSFORM_PYCARET_TYPE = "transform/pycaret"
    EXPLORE_PYCARET_TYPE = "explore/pycaret"
